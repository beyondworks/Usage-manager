...
앱은 권하기만 하고 아무것도 지우지 않는다. 직전 압축이 핸드오버를 저장한 뒤에 일어났다면 "clear 권장", 그렇지 않다면 "저장 먼저"로 문구가 갈린다.
...
- CPU **1% 안팎** (3분씩 네 번 실측 0.28 / 0.78 / 1.19 / 1.43% — 추적 중인 세션이 바쁠수록 올라간다), 메모리 **약 80MB**
