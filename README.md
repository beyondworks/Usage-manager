...
앱이 압축점 전에 미리 예고하기도 한다. 그 예고를 받고 핸드오버를 써 둔 세션은 압축점에서 다시 붙잡지 않는다. 다만 예고 시점은 설정한 기준선으로 계산한 짐작이어서, 설정이 적용되기 전에 열린 세션은 예고보다 한참 뒤에 압축된다. 그래서 예고 당시의 크기를 함께 적어 두고, 그 뒤로 5만 토큰 넘게 늘었으면 핸드오버가 이미 낡은 것으로 보아 한 번 더 붙잡는다.
